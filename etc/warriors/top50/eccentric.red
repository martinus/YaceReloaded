...
;name Eccentric
;author Roy van Rijn
;strategy Q4.5 - Stone+SDClear+Imp
;assert 1

; Frantic with a patial SD clear
; Does well on the hill, not against my benchmarks
...
cOff    equ     3912
cGate   dat     cOff, cOff+18
cIncr   spl.f   #cBomb+2,<1956
        mov.i   @cBomb,  }-6
        djn.f   -1,      <-7
cBomb   dat     #9,      {1
        spl     #8,      {-85
